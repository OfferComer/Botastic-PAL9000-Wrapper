...
func TestFormatLink(t *testing.T) {
	cases := []struct {
		...
		{
			input: "您可以通过Google Play下载和安装Mixin。如果要下载Apk，请通过浏览器打开https://mixin.one/mm或https://mixin-www.zeromesh.net/mm。对于iOS用户，请查看https://channel.mixinbots.com/dl。桌面版本请在浏览器